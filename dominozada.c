...
void inicio() {
	...
	else {  // se o codigo chegou aqui, nenhum dos jogadores recebeu uma dupla, e a soma das peças dos jogadores é igual 
...
}               // inicializando as pecas em -1 para poder operá-las
...
void carregarestado() {
    ...
    fclose(file);
}                  // com essas 2 funcoes, é possivel salvar o jogo e carrega-lo depois de fechado
